...
export const demoInsights: (Insight & { clientName: string })[] = [
  {
    ...
    severity: 'high',
    evidence: ['No response to email sent Dec 15', 'Last reply was Dec 10'],
    is_resolved: false,
  ...
  },
  {
    ...
    severity: 'medium',
    evidence: ['"Do you think we could scale this to other departments?"', 'Marketing team asking about similar solutions'],
    is_resolved: false,
  ...
  },
  {
    ...
    severity: 'low',
    evidence: ['"I\'m very happy with the progress so far"', 'Responded within 2 hours'],
    is_resolved: false,
  ...
  },
  {
    ...
    severity: 'medium',
    evidence: ['"Would definitely recommend to my network"', 'Results exceeded expectations'],
    is_resolved: false,
